-- ========================================
-- BANKODE CORE BANKING SCHEMA (COMPATIBLE VERSION)
-- ========================================
-- Compatible with existing Bankode tables
-- Uses existing column names: owner_uid, from_uid, to_uid
-- Adds missing indexes, constraints, triggers, RLS policies, and RPC functions
...
-- COMPLETION MESSAGE
-- ========================================
-- Bankode Core Banking Schema (Compatible Version) Applied Successfully
