...
(function () {
  ...
  const TRANSLATIONS = {
    ...
    en: {
      ...
      app_nostaglia:         'Nostaglia',
      app_nostaglia_desc:    'Retro music collection',
    ...
    ar: {
      ...
      app_nostaglia:         'نوستالجيا',
      app_nostaglia_desc:    'مجموعة الموسيقى الكلاسيكية',
      app_setta:             'ستة × تسعة',
    ...
    ur: {
      ...
      app_nostaglia:         'نوسٹالجیا',
      app_nostaglia_desc:    'کلاسک موسیقی مجموعہ',
