...
DROP TABLE IF EXISTS bankode_admin_actions CASCADE;
DROP TABLE IF EXISTS bankode_audit CASCADE;
DROP TABLE IF EXISTS bankode_auth CASCADE;
DROP TABLE IF EXISTS bankode_transactions CASCADE;
DROP TABLE IF EXISTS bankode_wallets CASCADE;

-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS bankode_create_audit(UUID, TEXT, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS bankode_admin_adjust(UUID, UUID, TEXT, INTEGER, TEXT) CASCADE;
DROP FUNCTION IF EXISTS bankode_mint_assets(UUID, UUID, TEXT, INTEGER, TEXT) CASCADE;
DROP FUNCTION IF EXISTS bankode_get_transactions(UUID, INTEGER, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS bankode_get_balances(UUID) CASCADE;
DROP FUNCTION IF EXISTS bankode_set_password(UUID, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS bankode_verify_password(UUID, TEXT) CASCADE;
...
-- Safe DROP statements included for clean installation